...
Before installing ISTools, we recommend manually installing a subset of core dependencies that are commonly associated with installation failures.

Installing these packages in advance can significantly improve installation stability.
