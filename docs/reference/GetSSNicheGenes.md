...
Retrieves gene-level data from SingleSampNiche objects for specified
samples.

## Usage

``` r
GetSSNicheGenes(IST_obj, loop_id, niche_key, ...)

# S3 method for class 'IST'
GetSSNicheGenes(IST_obj = NULL, loop_id = "LoopAllSamp", niche_key = NULL, ...)
```
