#' @title ISTools: Infectious Spatiotemporal Transcriptomics
#'
#' @description
#' A comprehensive toolkit for quality control, analysis, and exploration of spatial transcriptomics data.
#' 'ISTools' aims to enable users to identify spatial niches, interpret cell-cell communication contexts,
...
#' ISTools uses the following \code{\link[base]{options}} to configure behaviour:
#'
#' \describe{
#'   \item{\code{ISTools.memsafe}}{
...
#'   }
#'   \item{\code{ISTools.parallel.threads}}{
...
#' Useful links:
#' \itemize{
#'   \item Homepage: \url{https://github.com/YulongQin/ISTools}
#'   \item Documentation: \url{https://YulongQin.github.io/ISTools/}
#'   \item Report bugs at \url{https://github.com/YulongQin/ISTools/issues}
#' }
#'
#' @references
#' If you use ISTools in your publication, please cite:
#' \itemize{
#'   \item YulongQin, et al. "ISTools: A framework for spatial niche analysis." \emph{Journal Name}, Year. DOI: 10.xxxx/xxxxx
...
#' }
#'
#' @aliases ISTools-package ISTools
"_PACKAGE"
